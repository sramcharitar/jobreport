        ...
        <div class="w3-container">
            ...
            <div id="id01" class="w3-panel">
                ...
                <div class="w3-panel-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                    ...
                    <g:form class="w3-container" controller="login" action="updatePassword" method="POST">
                        <g:hiddenField name="spring-security-redirect" value="/siteReport/index"/>
                        <g:hiddenField name="resetPassword" value="${params.upid}"/>
                        <div class="w3-section">
                            <label><b><g:message code="chbUser.newPassword.title" default="New Password"/></b></label>
                            <g:passwordField class="w3-input w3-border w3-margin-bottom" name="password" value="" />
                            <label><b><g:message code="chbUser.confirmPassword.title" default="Confirm Password" /></b></label>
                            <g:passwordField class="w3-input w3-border" name="confirmPassword" value="" />
                            <button class="w3-button w3-block w3-green w3-section w3-padding" type="submit" name="_action_updatePassword" >
