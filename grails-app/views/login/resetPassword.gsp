    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="layout" class="clear">
                ...
                <g:form url="/login/sendPasswordResetLink" method="POST" name="loginForm">
                        ...
                        <tbody class="contentframework-stripedtable">
                            ...
                            <tr class="${hasErrors(bean:chbUser, field:'username', 'contentframework-required-cellhighlight')}">
                                ...
                                <td headers="loginFormUsername">
                                    <g:textField class="contentframework-textfield ${hasErrors(bean:chbUser, field:'username', 'contentframework-required-highlight')}" name="username" value="" />
                                </td>
                            </tr>
                            <tr class="${hasErrors(bean:chbUser, field:'emailAddress', 'contentframework-required-cellhighlight')}">
                                <td headers="loginFormEmailAddress" class="contentframework-formdatalabel">
                                    <a name="anchor-emailAddress" id="anchor-emailAddress"></a>
                                    <label for="emailAddress">
                                        <span class="contentframework-negativeindent">
                                            <b class="contentframework-required-asterisk">*</b>
                                        </span>
                                        <strong><g:message code="chbUser.emailAddress.title" default="Email Address" />:</strong>
                                    </label>
                                    <g:hasErrors bean="${chbUser}" field="emailAddress">
                                        <ul class="contentframework-required-description">
                                            <li>
                                                <g:img dir="images/contentframework" file="icon-formerror.gif" alt="Error" class="contentframework-required-icon"/>
                                                <g:fieldError bean="${chbUser}" field="emailAddress" />
                                            </li>
                                        </ul>
                                    </g:hasErrors>
                                </td>
                                <td headers="loginFormEmailAddress">
                                    <g:textField class="contentframework-textfield ${hasErrors(bean:chbUser, field:'emailAddress', 'contentframework-required-highlight')}" name="emailAddress" value="" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
