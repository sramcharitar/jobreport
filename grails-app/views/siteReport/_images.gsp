    ...
    <table class="contentframework">
        ...
        <tr>
            <td>
                ...
                <g:message code="document.image.title"/>: <input type="file" name="attachments" multiple="true" size="50"/>
            </td>
            <td>
        ...
        <tr class="subcopy">
            ...
            <td style="width:20px">
                <asset:image src="icons/delete.png"
                             ...
                             onclick="\$(location).prop('href', '/siteReport/deleteDocument?id=${document.id}');" />
            </td>
        </tr>
    </g:each>
    </tbody>
